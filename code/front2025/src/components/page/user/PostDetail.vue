          ...
          <div class="comment-user">
            ...
            <div class="comment-info">
              ...
              <div class="comment-actions" v-if="comment.reply">
                <span @click="replyComment(comment)">답글: {{ comment.reply }}</span>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    toggleLike() {
      if(this.type!=='02'){
            this.$message.warning("사용자만 즐겨찾기 가능합니다");
            return;
        }
